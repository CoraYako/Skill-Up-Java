...
public class AccountServiceImpl implements IAccountService {
    ...
    public AccountResponseDto createNewAccount(AccountRequestDto accountRequestDto) {
        ...
        CurrencyType currency = getCurrencyType(accountRequestDto.getCurrency());
        Account account;
    ...
    protected CurrencyType getCurrencyType(String type) {
    ...
    protected Account buildAccount(User user, CurrencyType currency, Double transactionLimit) {
